# Όροι και προϋποθέσεις για την δημοσίευση κειμένων
 ![Version](https://img.shields.io/static/v1?label=Έκδοση&message=3.0.0&color=brightgreen) ![When](https://img.shields.io/badge/%CE%A4%CE%B5%CE%BB%CE%B5%CF%85%CF%84%CE%B1%CE%AF%CE%B1%20%CE%91%CE%BD%CE%B1%CE%BD%CE%AD%CF%89%CF%83%CE%B7-%CE%9F%CE%BA%CF%84%CF%8E%CE%B2%CF%81%CE%B9%CE%BF%CF%82%202020-informational)
...
Αν και ελέγχουμε κάθε κείμενο που φτάνει στα χέρια μας, για πιθανή λογοκλοπή, ενδέχεται να δημοσιεύσουμε κάποιο κείμενο που ψευδώς το υπογράφει ο αποστολέας του, ως δημιουργός του κειμένου. Στην περίπτωση που εντοπίσετε κάποιο περιστατικό λογοκλοπής στον ιστότοπό μας, παρακαλώ [επικοινωνήστε](mailto:info@thebluez.gr) άμεσα μαζί μας.
