...
# Όροι και προϋποθέσεις για την δημοσίευση κειμένων
 ![Version](https://img.shields.io/static/v1?label=Έκδοση&message=3.1.0&color=brightgreen) ![When](https://img.shields.io/badge/%CE%A4%CE%B5%CE%BB%CE%B5%CF%85%CF%84%CE%B1%CE%AF%CE%B1%20%CE%91%CE%BD%CE%B1%CE%BD%CE%AD%CF%89%CF%83%CE%B7-%CE%A6%CE%B5%CE%B2%CF%81%CE%BF%CF%85%CE%AC%CF%81%CE%B9%CE%BF%CF%82%202021-informational)
...
Tο TheBluez.gr μπορεί να κάνει εξαιρέσεις και να δεχτεί κείμενα τα οποία **εμπεριέχουν** πολιτικό ύφος στις παρακάτω περιπτώσεις:
...
Το TheBluez.gr δεν δημοσιεύει δελτία τύπου και δεν προμοτάρει εκδηλώσεις, έργα τέχνης, βιβλία, συναυλίες, κλπ.
...
Δεν δημοσιεύουμε τυχαίες σκέψεις, κείμενα χωρίς συνοχή ή παραληρηματικό λόγο.

### 2.9 Ποίηση
###### [Terms [C290](#terms-c290)]

Το TheBluez.gr δεν δημοσιεύει κανένα είδος ποίησης και ο δημιουργός θα πρέπει να το γνωρίζει πριν υποβάλλει το έργο του προς εξέταση δημοσίευσης.
...
Κείμενα τα οποία υποβάλλονται στον ιστότοπο, τα οποία ανήκουν στις παραπάνω κατηγορίες, θα απορρίπτονται.
