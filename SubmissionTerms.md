...
Εάν χρειάζεστε την στήριξή μας, όσον αφορά την προβολή οποιασδήποτε εκδήλωσης, μην μας στέλνετε ένα ξερό δελτίο τύπου, αλλά επικοινωνήστε μαζί μας, ώστε να βρούμε τον καλύτερο και καταλληλότερο τρόπο για να σας βοηθήσουμε.
